...
> It returns a frozen `MetaTagsProps` object that should be assigned to a `baseMetaTags` property in your load data.
>
...
> It returns a frozen `MetaTagsProps` object that should be assigned to a `pageMetaTags` property in your load data.
>
