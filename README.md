...
| `robots`                           | string or boolean (default undefined) | Specifies robots content as a string or disables meta tags                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
The `robots` and `googlebot` meta tags can be passed a string, or disabled entirely by setting to `false`.
